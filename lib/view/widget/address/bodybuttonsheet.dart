import 'package:ecommers/controller/address/add_controller.dart';
...
class CustomAddressDetilesButtomSheet extends GetView<AddAddressControllerImp> {
  const CustomAddressDetilesButtomSheet({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return CustomBotton(onTap: (){ controller.markers.length!=0?Get.bottomSheet(
        Container(
